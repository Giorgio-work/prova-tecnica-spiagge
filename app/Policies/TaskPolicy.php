...
class TaskPolicy
{
    ...
    {
        // Only the task creator can restore the task
        return $user->id === $task->user_id;
    }
    ...
    {
        // Only the task creator can force delete the task
        return $user->id === $task->user_id;
    }

    /**
     * Determine whether the user can change the task status.
     */
    public function changeStatus(User $user, Task $task): bool
    {
        // Users can change status of tasks they created
        return $user->id === $task->user_id;
    }
}
